...
}) => T.Effect<OT.HasTracer & HasConsole & HasDocumentContext, FetchDataError.UnexpectedError | FetchDataError.NoSuchNestedDocumentTypeError, core.Document>;
declare type MakeDocumentInternalError = UnexpectedMarkdownError | UnexpectedMDXError | FetchDataError.NoSuchNestedDocumentTypeError;
export declare const getFlattenedPath: (relativeFilePath: string) => string;
export declare const testOnly_getDataForFieldDef: ({ fieldDef, rawFieldData, coreSchemaDef, options, relativeFilePath, contentDirPath, }: {
