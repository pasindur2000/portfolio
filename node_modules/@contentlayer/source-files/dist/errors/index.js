...
const fileName_1 = "packages/@contentlayer/source-files/src/errors/index.ts";
...
(function (FetchDataError) {
    ...
    class InvalidFrontmatterError extends Tagged('InvalidFrontmatterError') {
        constructor() {
            ...
            this.renderHeadline = ({ errorCount }) => `Invalid frontmatter data found for ${errorCount} documents.`;
    ...
    class InvalidMarkdownFileError extends Tagged('InvalidMarkdownFileError') {
        constructor() {
            super(...arguments);
            this.category = 'MissingOrIncompatibleData';
            this.renderHeadline = ({ errorCount }) => `Invalid markdown in ${errorCount} documents.`;
            this.renderLine = () => `"${this.documentFilePath}" failed with ${errorToString(this.error)}`;
        }
    }
    ...
    class InvalidYamlFileError extends Tagged('InvalidYamlFileError') {
        constructor() {
            super(...arguments);
            this.category = 'MissingOrIncompatibleData';
            this.renderHeadline = ({ errorCount }) => `Invalid YAML data in ${errorCount} documents.`;
            this.renderLine = () => `"${this.documentFilePath}" failed with ${errorToString(this.error)}`;
        }
    }
    ...
    class InvalidJsonFileError extends Tagged('InvalidJsonFileError') {
        constructor() {
            super(...arguments);
            this.category = 'MissingOrIncompatibleData';
            this.renderHeadline = ({ errorCount }) => `Invalid JSON data in ${errorCount} documents.`;
            this.renderLine = () => `"${this.documentFilePath}" failed with ${errorToString(this.error)}`;
        }
    }
    ...
    class ComputedValueError extends Tagged('ComputedValueError') {
        constructor() {
            super(...arguments);
            this.category = 'MissingOrIncompatibleData';
            this.renderHeadline = ({ errorCount }) => `Error during computed field exection for ${errorCount} documents.`;
            this.renderLine = () => `"${this.documentFilePath}" failed with ${errorToString(this.error)}`;
        }
    }
    ...
    class UnsupportedFileExtension extends Tagged('UnsupportedFileExtension') {
        constructor() {
            super(...arguments);
            this.category = 'MissingOrIncompatibleData';
            this.renderHeadline = ({ errorCount }) => `Found unsupported file extensions for ${errorCount} documents`;
    ...
    class FileExtensionMismatch extends Tagged('FileExtensionMismatch') {
        constructor() {
            super(...arguments);
            this.category = 'MissingOrIncompatibleData';
            this.renderHeadline = ({ errorCount }) => `File extension not compatible with \`contentType\` for ${errorCount} documents`;
            this.renderLine = () => {
    ...
    class CouldNotDetermineDocumentTypeError extends Tagged('CouldNotDetermineDocumentTypeError') {
        constructor() {
            ...
            this.renderHeadline = ({ errorCount, options, schemaDef }) => {
...
one of the following document type names: ${validTypeNames}).`;
    ...
    class NoSuchDocumentTypeError extends Tagged('NoSuchDocumentTypeError') {
        constructor() {
            super(...arguments);
            this.category = 'MissingOrIncompatibleData';
            this.renderHeadline = ({ errorCount, schemaDef }) => {
                const validTypeNames = Object.keys(schemaDef.documentTypeDefMap).join(', ');
                return `\
...
`;
    ...
    class MissingRequiredFieldsError extends Tagged('MissingRequiredFieldsError') {
        constructor() {
            super(...arguments);
            this.category = 'MissingOrIncompatibleData';
            this.renderHeadline = ({ errorCount }) => `Missing required fields for ${errorCount} documents`;
            this.renderLine = () => {
...
${extraFields} `;
    ...
    class ReferencedFileDoesNotExistError extends Tagged('ReferencedFileDoesNotExistError') {
        constructor() {
            super(...arguments);
            this.category = 'IncompatibleFieldData';
            this.renderHeadline = ({ errorCount, contentDirPath }) => `\
