...
export const handleFetchDataErrors = ({ errors, documentCount, options, flags, schemaDef, contentDirPath, verbose, }) => T.gen(function* ($) {
    ...
    yield* $(T.log(errorMessage), fileName_1 + ":44:13");
    if (shouldFail) {
        yield* $(T.fail(new core.HandledFetchDataError(), fileName_1 + ":47:22"), fileName_1 + ":47:15");
    }
}, fileName_1 + ":27:8");
...
const aggregateFetchDataErrors = ({ errors, documentCount, options, shouldFail, schemaDef, contentDirPath, verbose, }) => {
