...
export class DevCommand extends BaseCommand {
    constructor() {
        super(...arguments);
        this.executeSafe = () => (S.runDrain(S.tap_(S.chainSwitchMapEitherRight((source) => core.generateDotpkgStream({ source, verbose: this.verbose }))(S.tapSkipFirstRight(() => T.log(`Contentlayer config change detected. Updating type definitions and data...`))(S.chain_(S.fromEffect(this.clearCacheIfNeeded()), () => core.getConfigWatch({ configPath: this.configPath })))), E.fold((error) => T.log(errorToString(error)), core.logGenerateInfo))));
    }
}
