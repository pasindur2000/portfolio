    ...
    <>
      ...
      >
        ...
        <h1 className="heroTitle inline-block max-w-2xl lg:max-w-4xl  w-auto relative text-3xl md:text-4xl lg:text-5xl tracking-tighter mb-10 font-bold heroShinyBg">
          ...
          /> */}
          <img
            className="sqD squiggle-hero-nextjs hidden top-[75px] right-0  w-10 h-10"
            style={{ animationDelay: "0.2s" }}
            src="/static/doodles/hero/ab.png"
          />
          <img
            className="sqD bottom-[-300px] -right-1/4 sm:right-[-20%] lg:bottom-[-310px] lg:right-[-120px] w-[400px] w-2 "
            style={{ animationDelay: "0.3s" }}
            src="/static/doodles/hero/ab.png"
          />
          <img
            className="sqD hidden sm:block bottom-[-340px] left-[-180px]  w-10 h-10"
            style={{ animationDelay: "0.4s" }}
            src="/static/doodles/hero/ab.png"
          />
          <img
            className="sqD hidden sm:block left-[100px] lg:left-[160px] bottom-[-150px]  w-16 h-16"
          ...
          />
          {/* <img
            className="sqD squiggle-hero-pop1 hidden sm:block sm:top-[-130px] sm:left-[15%] lg:top-[-130px] lg:left-[120px]  w-10 h-10"
            src="/static/doodles/hero/ab.png"
          /> */}
          <img
